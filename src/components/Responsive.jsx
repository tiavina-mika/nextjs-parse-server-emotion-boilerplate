...
export const Mobile = (props) => {
  ...
  return <MediaQuery {...props} maxWidth={MOBILE_BREAKPOINT} deviceWidth={width} />;
};
...
export const Desktop = (props) => {
  const { width } = useContext(ResponsiveContext);
  return <MediaQuery {...props} minWidth={DESKTOP_BREAKPOINT + 1} deviceWidth={width} />;
};

export const LargeDesktop = (props) => {
  const { width } = useContext(ResponsiveContext);
  return <MediaQuery {...props} minWidth={LARGE_DESKTOP_BREAKPOINT + 1} deviceWidth={width} />;
};
